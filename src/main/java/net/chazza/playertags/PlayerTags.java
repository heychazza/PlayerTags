package net.chazza.playertags;

import net.chazza.playertags.api.Tag;
import net.chazza.playertags.command.util.CommandExecutor;
import net.chazza.playertags.command.util.CommandManager;
import net.chazza.playertags.config.Lang;
import net.chazza.playertags.config.TagManager;
import net.chazza.playertags.event.JoinListener;
import net.chazza.playertags.hook.PlaceholderAPIHook;
import net.chazza.playertags.maven.LibraryLoader;
import net.chazza.playertags.maven.MavenLibrary;
import net.chazza.playertags.maven.Repository;
import net.chazza.playertags.storage.PlayerData;
import net.chazza.playertags.storage.StorageHandler;
import net.chazza.playertags.storage.mongodb.MongoDBHandler;
import net.chazza.playertags.storage.mysql.MySQLHandler;
import net.chazza.playertags.storage.sqlite.SQLiteHandler;
import net.chazza.playertags.util.Common;
import net.chazza.playertags.util.ConsoleFilter;
...
@MavenLibrary(groupId = "com.github.hazebyte", artifactId = "base", version = "0.0.0", repo = @Repository(url = "https://jitpack.io"))
